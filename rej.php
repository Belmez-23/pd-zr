...
<div id="MiniBlok" style="height: auto; width: 22%;">
<h2>'.$row['имя'].'</h2>
...
<div id="MiniBlok" align="left" style="width: 74%;"><H2>Отклоненные заказы</H2>';
$state1 = $pdo->query('SELECT * FROM `Заказ` WHERE `кодСтатуса` = 4 AND `кодПользователя` = '.$row['кодПользователя']);
$i = 0;
